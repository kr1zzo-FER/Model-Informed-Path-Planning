...
bool user_action_interfaces__msg__start_goal_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("user_action_interfaces.msg._start_goal_msg.StartGoalMsg", full_classname_dest, 55) == 0);
  }
  user_action_interfaces__msg__StartGoalMsg * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of StartGoalMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("user_action_interfaces.msg._start_goal_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StartGoalMsg");
