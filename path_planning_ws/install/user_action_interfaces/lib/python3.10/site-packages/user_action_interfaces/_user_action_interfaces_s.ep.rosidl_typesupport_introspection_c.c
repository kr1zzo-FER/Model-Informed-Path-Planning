...
static PyMethodDef user_action_interfaces__methods[] = {
  {NULL, NULL, 0, NULL}  /* sentinel */
};

static struct PyModuleDef user_action_interfaces__module = {
  PyModuleDef_HEAD_INIT,
  "_user_action_interfaces_support",
  "_user_action_interfaces_doc",
  -1,  /* -1 means that the module keeps state in global variables */
  user_action_interfaces__methods,
  NULL,
  NULL,
  NULL,
  NULL,
...
static void * user_action_interfaces__msg__path_msg__create_ros_message(void)
{
  return user_action_interfaces__msg__PathMsg__create();
}

static void user_action_interfaces__msg__path_msg__destroy_ros_message(void * raw_ros_message)
{
  user_action_interfaces__msg__PathMsg * ros_message = (user_action_interfaces__msg__PathMsg *)raw_ros_message;
  user_action_interfaces__msg__PathMsg__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool user_action_interfaces__msg__path_msg__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * user_action_interfaces__msg__path_msg__convert_to_py(void * raw_ros_message);


ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(user_action_interfaces, msg, PathMsg);

int8_t
_register_msg_type__msg__path_msg(PyObject * pymodule)
{
  int8_t err;

  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&user_action_interfaces__msg__path_msg__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "create_ros_message_msg__msg__path_msg",
    pyobject_create_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_create_ros_message);
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&user_action_interfaces__msg__path_msg__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "destroy_ros_message_msg__msg__path_msg",
    pyobject_destroy_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_destroy_ros_message);
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&user_action_interfaces__msg__path_msg__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_from_py_msg__msg__path_msg",
    pyobject_convert_from_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_from_py);
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&user_action_interfaces__msg__path_msg__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_to_py_msg__msg__path_msg",
    pyobject_convert_to_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_to_py);
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(user_action_interfaces, msg, PathMsg),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "type_support_msg__msg__path_msg",
    pyobject_type_support);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_type_support);
...
PyMODINIT_FUNC
PyInit_user_action_interfaces_s__rosidl_typesupport_introspection_c(void)
{
  PyObject * pymodule = NULL;
  pymodule = PyModule_Create(&user_action_interfaces__module);
  if (!pymodule) {
    return NULL;
  }
  int8_t err;
  ...
  err = _register_msg_type__msg__path_msg(pymodule);
  if (err) {
    Py_XDECREF(pymodule);
    return NULL;
  }
