...
#include "user_action_interfaces/msg/detail/path_msg__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = user_action_interfaces::msg::PathMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const user_action_interfaces::msg::PathMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<user_action_interfaces::msg::PathMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PathMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const user_action_interfaces::msg::PathMsg *>(
...
static size_t _PathMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PathMsg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PathMsg__callbacks = {
...
static rosidl_message_type_support_t _PathMsg__handle = {
...
{
  return &user_action_interfaces::msg::typesupport_fastrtps_cpp::_PathMsg__handle;
}
