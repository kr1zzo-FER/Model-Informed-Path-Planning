...
#include "user_action_interfaces/msg/detail/coast_msg__rosidl_typesupport_fastrtps_c.h"
...
using _CoastMsg__ros_msg_type = user_action_interfaces__msg__CoastMsg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CoastMsg__ros_msg_type * ros_message = static_cast<const _CoastMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _CoastMsg__ros_msg_type * ros_message = static_cast<_CoastMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_user_action_interfaces__msg__CoastMsg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CoastMsg__ros_msg_type * ros_message = static_cast<const _CoastMsg__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _CoastMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_user_action_interfaces__msg__CoastMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t max_serialized_size_user_action_interfaces__msg__CoastMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = user_action_interfaces__msg__CoastMsg;
    is_plain =
      (
...
static size_t _CoastMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_user_action_interfaces__msg__CoastMsg(
...
static message_type_support_callbacks_t __callbacks_CoastMsg = {
...
static rosidl_message_type_support_t _CoastMsg__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CoastMsg,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_action_interfaces, msg, CoastMsg)() {
  return &_CoastMsg__type_support;
}
