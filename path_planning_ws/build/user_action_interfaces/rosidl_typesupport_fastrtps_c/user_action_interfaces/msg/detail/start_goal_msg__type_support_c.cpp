...
#include "user_action_interfaces/msg/detail/start_goal_msg__rosidl_typesupport_fastrtps_c.h"
...
using _StartGoalMsg__ros_msg_type = user_action_interfaces__msg__StartGoalMsg;

static bool _StartGoalMsg__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _StartGoalMsg__ros_msg_type * ros_message = static_cast<const _StartGoalMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _StartGoalMsg__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _StartGoalMsg__ros_msg_type * ros_message = static_cast<_StartGoalMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_user_action_interfaces__msg__StartGoalMsg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StartGoalMsg__ros_msg_type * ros_message = static_cast<const _StartGoalMsg__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _StartGoalMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_user_action_interfaces__msg__StartGoalMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t max_serialized_size_user_action_interfaces__msg__StartGoalMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = user_action_interfaces__msg__StartGoalMsg;
    is_plain =
      (
...
static size_t _StartGoalMsg__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_user_action_interfaces__msg__StartGoalMsg(
...
static message_type_support_callbacks_t __callbacks_StartGoalMsg = {
  "user_action_interfaces::msg",
  "StartGoalMsg",
  _StartGoalMsg__cdr_serialize,
  _StartGoalMsg__cdr_deserialize,
  _StartGoalMsg__get_serialized_size,
  _StartGoalMsg__max_serialized_size
};

static rosidl_message_type_support_t _StartGoalMsg__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_StartGoalMsg,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_action_interfaces, msg, StartGoalMsg)() {
  return &_StartGoalMsg__type_support;
}
