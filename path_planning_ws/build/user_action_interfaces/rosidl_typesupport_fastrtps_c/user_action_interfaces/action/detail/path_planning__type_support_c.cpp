...
#include "user_action_interfaces/action/detail/path_planning__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // start_goal
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // start_goal

// forward declare type support functions


using _PathPlanning_Goal__ros_msg_type = user_action_interfaces__action__PathPlanning_Goal;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: start_goal
  {
    size_t size = ros_message->start_goal.size;
    auto array_ptr = ros_message->start_goal.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: start_goal
  {
    ...
    if (ros_message->start_goal.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->start_goal);
    }
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->start_goal, size)) {
      fprintf(stderr, "failed to create array for field 'start_goal'");
      return false;
    }
    auto array_ptr = ros_message->start_goal.data;
...
size_t get_serialized_size_user_action_interfaces__action__PathPlanning_Goal(
  const void * untyped_ros_message,
...
static uint32_t _PathPlanning_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_user_action_interfaces__action__PathPlanning_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t max_serialized_size_user_action_interfaces__action__PathPlanning_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = user_action_interfaces__action__PathPlanning_Goal;
    is_plain =
      (
...
static size_t _PathPlanning_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_user_action_interfaces__action__PathPlanning_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_Goal)() {
...
using _PathPlanning_Result__ros_msg_type = user_action_interfaces__action__PathPlanning_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t get_serialized_size_user_action_interfaces__action__PathPlanning_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PathPlanning_Result__ros_msg_type * ros_message = static_cast<const _PathPlanning_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_user_action_interfaces__action__PathPlanning_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t max_serialized_size_user_action_interfaces__action__PathPlanning_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = user_action_interfaces__action__PathPlanning_Result;
    is_plain =
      (
...
static size_t _PathPlanning_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_user_action_interfaces__action__PathPlanning_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_Result)() {
...
using _PathPlanning_Feedback__ros_msg_type = user_action_interfaces__action__PathPlanning_Feedback;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: partial_path
  {
    ...
    if (ros_message->partial_path.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->partial_path);
    }
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->partial_path, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t get_serialized_size_user_action_interfaces__action__PathPlanning_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PathPlanning_Feedback__ros_msg_type * ros_message = static_cast<const _PathPlanning_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_user_action_interfaces__action__PathPlanning_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t max_serialized_size_user_action_interfaces__action__PathPlanning_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = user_action_interfaces__action__PathPlanning_Feedback;
    is_plain =
      (
...
static size_t _PathPlanning_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_user_action_interfaces__action__PathPlanning_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_Feedback)() {
...
// already included above
// #include "user_action_interfaces/action/detail/path_planning__functions.h"  // goal
...
using _PathPlanning_SendGoal_Request__ros_msg_type = user_action_interfaces__action__PathPlanning_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t get_serialized_size_user_action_interfaces__action__PathPlanning_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PathPlanning_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _PathPlanning_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_user_action_interfaces__action__PathPlanning_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_user_action_interfaces__action__PathPlanning_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t max_serialized_size_user_action_interfaces__action__PathPlanning_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_user_action_interfaces__action__PathPlanning_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = user_action_interfaces__action__PathPlanning_SendGoal_Request;
    is_plain =
      (
...
static size_t _PathPlanning_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_user_action_interfaces__action__PathPlanning_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_SendGoal_Request)() {
...
using _PathPlanning_SendGoal_Response__ros_msg_type = user_action_interfaces__action__PathPlanning_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t get_serialized_size_user_action_interfaces__action__PathPlanning_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PathPlanning_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _PathPlanning_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_user_action_interfaces__action__PathPlanning_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t max_serialized_size_user_action_interfaces__action__PathPlanning_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = user_action_interfaces__action__PathPlanning_SendGoal_Response;
    is_plain =
      (
...
static size_t _PathPlanning_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_user_action_interfaces__action__PathPlanning_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_SendGoal_Response)() {
...
using _PathPlanning_SendGoal_Event__ros_msg_type = user_action_interfaces__action__PathPlanning_SendGoal_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PathPlanning_SendGoal_Event__ros_msg_type * ros_message = static_cast<const _PathPlanning_SendGoal_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_SendGoal_Request
      )()->data);
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_SendGoal_Response
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _PathPlanning_SendGoal_Event__ros_msg_type * ros_message = static_cast<_PathPlanning_SendGoal_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      user_action_interfaces__action__PathPlanning_SendGoal_Request__Sequence__fini(&ros_message->request);
    }
    if (!user_action_interfaces__action__PathPlanning_SendGoal_Request__Sequence__init(&ros_message->request, size)) {
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      user_action_interfaces__action__PathPlanning_SendGoal_Response__Sequence__fini(&ros_message->response);
    }
    if (!user_action_interfaces__action__PathPlanning_SendGoal_Response__Sequence__init(&ros_message->response, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t get_serialized_size_user_action_interfaces__action__PathPlanning_SendGoal_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PathPlanning_SendGoal_Event__ros_msg_type * ros_message = static_cast<const _PathPlanning_SendGoal_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_user_action_interfaces__action__PathPlanning_SendGoal_Request(
  ...
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_user_action_interfaces__action__PathPlanning_SendGoal_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _PathPlanning_SendGoal_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_user_action_interfaces__action__PathPlanning_SendGoal_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t max_serialized_size_user_action_interfaces__action__PathPlanning_SendGoal_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_user_action_interfaces__action__PathPlanning_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_user_action_interfaces__action__PathPlanning_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = user_action_interfaces__action__PathPlanning_SendGoal_Event;
    is_plain =
      (
...
static size_t _PathPlanning_SendGoal_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_user_action_interfaces__action__PathPlanning_SendGoal_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_PathPlanning_SendGoal_Event = {
  "user_action_interfaces::action",
...
static rosidl_message_type_support_t _PathPlanning_SendGoal_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PathPlanning_SendGoal_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_SendGoal_Event)() {
  return &_PathPlanning_SendGoal_Event__type_support;
}
...
static rosidl_service_type_support_t PathPlanning_SendGoal__handle = {
  ...
  &_PathPlanning_SendGoal_Request__type_support,
  &_PathPlanning_SendGoal_Response__type_support,
  &_PathPlanning_SendGoal_Event__type_support,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_SendGoal)() {
...
using _PathPlanning_GetResult_Request__ros_msg_type = user_action_interfaces__action__PathPlanning_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t get_serialized_size_user_action_interfaces__action__PathPlanning_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PathPlanning_GetResult_Request__ros_msg_type * ros_message = static_cast<const _PathPlanning_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_user_action_interfaces__action__PathPlanning_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t max_serialized_size_user_action_interfaces__action__PathPlanning_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = user_action_interfaces__action__PathPlanning_GetResult_Request;
    is_plain =
      (
...
static size_t _PathPlanning_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_user_action_interfaces__action__PathPlanning_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_GetResult_Request)() {
...
// already included above
// #include "user_action_interfaces/action/detail/path_planning__functions.h"  // result
...
using _PathPlanning_GetResult_Response__ros_msg_type = user_action_interfaces__action__PathPlanning_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t get_serialized_size_user_action_interfaces__action__PathPlanning_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PathPlanning_GetResult_Response__ros_msg_type * ros_message = static_cast<const _PathPlanning_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_user_action_interfaces__action__PathPlanning_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_user_action_interfaces__action__PathPlanning_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t max_serialized_size_user_action_interfaces__action__PathPlanning_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_user_action_interfaces__action__PathPlanning_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = user_action_interfaces__action__PathPlanning_GetResult_Response;
    is_plain =
      (
...
static size_t _PathPlanning_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_user_action_interfaces__action__PathPlanning_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_GetResult_Response)() {
...
using _PathPlanning_GetResult_Event__ros_msg_type = user_action_interfaces__action__PathPlanning_GetResult_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PathPlanning_GetResult_Event__ros_msg_type * ros_message = static_cast<const _PathPlanning_GetResult_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_GetResult_Request
      )()->data);
    size_t size = ros_message->request.size;
    auto array_ptr = ros_message->request.data;
    if (size > 1) {
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_GetResult_Response
      )()->data);
    size_t size = ros_message->response.size;
    auto array_ptr = ros_message->response.data;
    if (size > 1) {
  ...
  void * untyped_ros_message)
{
  ...
  _PathPlanning_GetResult_Event__ros_msg_type * ros_message = static_cast<_PathPlanning_GetResult_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    ...
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->request.data) {
      user_action_interfaces__action__PathPlanning_GetResult_Request__Sequence__fini(&ros_message->request);
    }
    if (!user_action_interfaces__action__PathPlanning_GetResult_Request__Sequence__init(&ros_message->request, size)) {
      fprintf(stderr, "failed to create array for field 'request'");
      return false;
    }
    auto array_ptr = ros_message->request.data;
  ...
  // Field name: response
  {
    ...
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->response.data) {
      user_action_interfaces__action__PathPlanning_GetResult_Response__Sequence__fini(&ros_message->response);
    }
    if (!user_action_interfaces__action__PathPlanning_GetResult_Response__Sequence__init(&ros_message->response, size)) {
      fprintf(stderr, "failed to create array for field 'response'");
      return false;
    }
    auto array_ptr = ros_message->response.data;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t get_serialized_size_user_action_interfaces__action__PathPlanning_GetResult_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PathPlanning_GetResult_Event__ros_msg_type * ros_message = static_cast<const _PathPlanning_GetResult_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_user_action_interfaces__action__PathPlanning_GetResult_Request(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_user_action_interfaces__action__PathPlanning_GetResult_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _PathPlanning_GetResult_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_user_action_interfaces__action__PathPlanning_GetResult_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t max_serialized_size_user_action_interfaces__action__PathPlanning_GetResult_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_user_action_interfaces__action__PathPlanning_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_user_action_interfaces__action__PathPlanning_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = user_action_interfaces__action__PathPlanning_GetResult_Event;
    is_plain =
      (
      offsetof(DataType, response) +
      last_member_size
...
static size_t _PathPlanning_GetResult_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_user_action_interfaces__action__PathPlanning_GetResult_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_PathPlanning_GetResult_Event = {
  "user_action_interfaces::action",
...
static rosidl_message_type_support_t _PathPlanning_GetResult_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PathPlanning_GetResult_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_GetResult_Event)() {
  return &_PathPlanning_GetResult_Event__type_support;
}
...
static rosidl_service_type_support_t PathPlanning_GetResult__handle = {
  ...
  get_service_typesupport_handle_function,
  &_PathPlanning_GetResult_Request__type_support,
  &_PathPlanning_GetResult_Response__type_support,
  &_PathPlanning_GetResult_Event__type_support,
  ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_CREATE_EVENT_MESSAGE_SYMBOL_NAME(
    rosidl_typesupport_c,
    user_action_interfaces,
    action,
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_GetResult)() {
...
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
// already included above
// #include "user_action_interfaces/action/detail/path_planning__functions.h"  // feedback
...
using _PathPlanning_FeedbackMessage__ros_msg_type = user_action_interfaces__action__PathPlanning_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t get_serialized_size_user_action_interfaces__action__PathPlanning_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PathPlanning_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _PathPlanning_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_user_action_interfaces__action__PathPlanning_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_user_action_interfaces__action__PathPlanning_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_user_action_interfaces
size_t max_serialized_size_user_action_interfaces__action__PathPlanning_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_user_action_interfaces__action__PathPlanning_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = user_action_interfaces__action__PathPlanning_FeedbackMessage;
    is_plain =
      (
...
static size_t _PathPlanning_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_user_action_interfaces__action__PathPlanning_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_action_interfaces, action, PathPlanning_FeedbackMessage)() {
