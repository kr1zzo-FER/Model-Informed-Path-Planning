...
static const _CoastMsg_type_support_symbol_names_t _CoastMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, user_action_interfaces, msg, CoastMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, user_action_interfaces, msg, CoastMsg)),
  }
};
...
{
  return &::user_action_interfaces::msg::rosidl_typesupport_cpp::CoastMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, user_action_interfaces, msg, CoastMsg)() {
  return get_message_type_support_handle<user_action_interfaces::msg::CoastMsg>();
}
