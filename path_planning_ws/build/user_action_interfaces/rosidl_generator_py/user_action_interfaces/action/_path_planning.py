    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'user_action_interfaces.action.PathPlanning_Goal')
            logger.debug(
...
class Metaclass_PathPlanning_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'user_action_interfaces.action.PathPlanning_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_PathPlanning_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'user_action_interfaces.action.PathPlanning_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PathPlanning_Feedback(metaclass=Metaclass_PathPlanning_Feedback):
    ...
    def __init__(self, **kwargs):
        ...
        if self._check_fields:
            assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
                'Invalid arguments passed to constructor: %s' % \
                ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.partial_path = array.array('i', kwargs.get('partial_path', []))
    ...
    def partial_path(self, value):
        if self._check_fields:
            if isinstance(value, array.array):
                assert value.typecode == 'i', \
                    "The 'partial_path' array.array() must have the type code of 'i'"
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= -2147483648 and val < 2147483648 for val in value)), \
                "The 'partial_path' field must be a set or sequence and each value of type 'int' and each integer in [-2147483648, 2147483647]"
        self._partial_path = array.array('i', value)
...
class PathPlanning_SendGoal_Request(metaclass=Metaclass_PathPlanning_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'user_action_interfaces/PathPlanning_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['user_action_interfaces', 'action'], 'PathPlanning_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from user_action_interfaces.action._path_planning import PathPlanning_Goal
...
class Metaclass_PathPlanning_SendGoal_Event(type):
    """Metaclass of message 'PathPlanning_SendGoal_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action__path_planning__send_goal__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action__path_planning__send_goal__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action__path_planning__send_goal__event
            cls._TYPE_SUPPORT = module.type_support_msg__action__path_planning__send_goal__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action__path_planning__send_goal__event
...
class PathPlanning_SendGoal_Event(metaclass=Metaclass_PathPlanning_SendGoal_Event):
    """Message class 'PathPlanning_SendGoal_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<user_action_interfaces/PathPlanning_SendGoal_Request, 1>',
        'response': 'sequence<user_action_interfaces/PathPlanning_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['user_action_interfaces', 'action'], 'PathPlanning_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['user_action_interfaces', 'action'], 'PathPlanning_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from user_action_interfaces.action import PathPlanning_SendGoal_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, PathPlanning_SendGoal_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'PathPlanning_SendGoal_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from user_action_interfaces.action import PathPlanning_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, PathPlanning_SendGoal_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'PathPlanning_SendGoal_Response'"
...
class Metaclass_PathPlanning_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'user_action_interfaces.action.PathPlanning_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from user_action_interfaces.action import _path_planning
            ...
            if _path_planning.Metaclass_PathPlanning_SendGoal_Event._TYPE_SUPPORT is None:
                _path_planning.Metaclass_PathPlanning_SendGoal_Event.__import_type_support__()


class PathPlanning_SendGoal(metaclass=Metaclass_PathPlanning_SendGoal):
    from user_action_interfaces.action._path_planning import PathPlanning_SendGoal_Request as Request
    from user_action_interfaces.action._path_planning import PathPlanning_SendGoal_Response as Response
    from user_action_interfaces.action._path_planning import PathPlanning_SendGoal_Event as Event
...
class PathPlanning_GetResult_Response(metaclass=Metaclass_PathPlanning_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'user_action_interfaces/PathPlanning_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['user_action_interfaces', 'action'], 'PathPlanning_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from user_action_interfaces.action._path_planning import PathPlanning_Result
...
class Metaclass_PathPlanning_GetResult_Event(type):
    """Metaclass of message 'PathPlanning_GetResult_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action__path_planning__get_result__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action__path_planning__get_result__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action__path_planning__get_result__event
            cls._TYPE_SUPPORT = module.type_support_msg__action__path_planning__get_result__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action__path_planning__get_result__event
...
class PathPlanning_GetResult_Event(metaclass=Metaclass_PathPlanning_GetResult_Event):
    """Message class 'PathPlanning_GetResult_Event'."""
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<user_action_interfaces/PathPlanning_GetResult_Request, 1>',
        'response': 'sequence<user_action_interfaces/PathPlanning_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['user_action_interfaces', 'action'], 'PathPlanning_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['user_action_interfaces', 'action'], 'PathPlanning_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from user_action_interfaces.action import PathPlanning_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, PathPlanning_GetResult_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'PathPlanning_GetResult_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from user_action_interfaces.action import PathPlanning_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, PathPlanning_GetResult_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'PathPlanning_GetResult_Response'"
        self._response = value
...
class Metaclass_PathPlanning_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'user_action_interfaces.action.PathPlanning_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            if _path_planning.Metaclass_PathPlanning_GetResult_Event._TYPE_SUPPORT is None:
                _path_planning.Metaclass_PathPlanning_GetResult_Event.__import_type_support__()


class PathPlanning_GetResult(metaclass=Metaclass_PathPlanning_GetResult):
    from user_action_interfaces.action._path_planning import PathPlanning_GetResult_Request as Request
    from user_action_interfaces.action._path_planning import PathPlanning_GetResult_Response as Response
    from user_action_interfaces.action._path_planning import PathPlanning_GetResult_Event as Event
...
class Metaclass_PathPlanning_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'user_action_interfaces.action.PathPlanning_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PathPlanning_FeedbackMessage(metaclass=Metaclass_PathPlanning_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'user_action_interfaces/PathPlanning_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['user_action_interfaces', 'action'], 'PathPlanning_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from user_action_interfaces.action._path_planning import PathPlanning_Feedback
...
class Metaclass_PathPlanning(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'user_action_interfaces.action.PathPlanning')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PathPlanning(metaclass=Metaclass_PathPlanning):
    ...
    from user_action_interfaces.action._path_planning import PathPlanning_Goal as Goal
    # The result message defined in the action definition.
    from user_action_interfaces.action._path_planning import PathPlanning_Result as Result
    # The feedback message defined in the action definition.
    from user_action_interfaces.action._path_planning import PathPlanning_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from user_action_interfaces.action._path_planning import PathPlanning_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from user_action_interfaces.action._path_planning import PathPlanning_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from user_action_interfaces.action._path_planning import PathPlanning_FeedbackMessage as FeedbackMessage
