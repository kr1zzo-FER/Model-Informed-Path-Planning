...
binary_path = ws_root /"src/map_server/processed_maps"
...
class MapProcess(Node):
    ...
    def process_map(self):
        ...
        test_dictionary_path = binary_path/f'processed_map_{self.save_file}'

        print(test_dictionary_path)

        test_dictionary = load_binary_data(test_dictionary_path)
