...
### System Architecture and Implementation of the Vessel Path-Planning Module

### ROS2 Version: [Jazzy Jalisco](https://docs.ros.org/en/jazzy/index.html)

### Tested On: [Ubuntu 24.04 LTS Noble Numbat](https://ubuntu.com/blog/upgrade-your-desktop-ubuntu-24-04-lts)
...
Credits for the solution: [AskUbuntu - Issues with pip in Ubuntu 24.04 LTS](https://askubuntu.com/questions/1525172/issues-with-pip-in-ubuntu-24-04-lts).
...
Alternatively, you can run it in the terminal every time before running the package in *path_planning_ws*:
```sh
