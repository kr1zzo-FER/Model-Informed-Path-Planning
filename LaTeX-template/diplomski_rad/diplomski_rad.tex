...
\title{Model-informed global path planning and control of an autonomous vessel}

% Naslov na hrvatskom jeziku / Title in Croatian
\naslov{Modelski informirano globalno planiranje putanja i upravljanja autonomnoga plovila}
